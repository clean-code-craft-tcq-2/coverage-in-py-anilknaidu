...
class send_alert:
  send_alert_dcn = {'TO_CONTROLLER':"send_to_controller", 'TO_EMAIL':"send_to_email"}
...
class battery_check_and_alert(send_alert):
  ...
  def infer_breach(self,lowerLimit,upperLimit ):
    if self.temperatureInC in range(lowerLimit,upperLimit+1):
      return 'NORMAL'
